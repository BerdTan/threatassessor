...
The scoring rubric itself is open — weights, signals, and the synonym tables used for MITRE alignment: github.com/BerdTan/threatassessor/blob/master/docs/TATB_RUBRIC.md
