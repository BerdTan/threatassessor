...
_MULTI_LAYER_CONTROLS: dict = {
    ...
    "rate limiting":        ["prevention", "detect", "isolate", "respond"],  # circuit-breaker = respond
    "api gateway":          ["prevention", "detect", "isolate"],  # centralises access control
    "api access control":   ["prevention", "isolate", "respond"],  # revoke/quarantine = respond
    ...
    "prompt_filter":        ["prevention", "detect"],
    "prompt injection":     ["prevention", "detect"],
    "output filter":        ["prevention", "detect"],
    "output_filter":        ["prevention", "detect"],
    "llm output":           ["prevention", "detect"],
    "content_moderation":   ["prevention", "detect", "respond"],  # remove content = respond
    "content moderation":   ["prevention", "detect", "respond"],
    "context_grounding":    ["prevention", "detect"],
    "context grounding":    ["prevention", "detect"],
    "capability_restrict":  ["prevention", "isolate"],
    "capability restrict":  ["prevention", "isolate"],
    "human_oversight":      ["detect", "respond"],   # human review = respond
    "human oversight":      ["detect", "respond"],
    "human_in_loop":        ["detect", "respond"],
    "human in the loop":    ["detect", "respond"],
    "web content filter":   ["prevention", "detect", "isolate"],
    "web content":          ["prevention", "detect"],
    ...
    "secrets_management":   ["prevention", "isolate"],
    "secret management":    ["prevention", "isolate"],
    "authentication":       ["prevention", "isolate"],
    "access_control":       ["prevention", "isolate"],
    "access control":       ["prevention", "isolate"],
    "sandbox":              ["prevention", "isolate"],
    "sandboxing":           ["prevention", "isolate"],
